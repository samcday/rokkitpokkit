...
CHUNK_PREFIX="${COMPOSE_CHUNK_PREFIX:-casync/default.castr}"
INDEX_PREFIX="${COMPOSE_INDEX_PREFIX:-casync}"
MANIFEST_PREFIX="${COMPOSE_MANIFEST_PREFIX:-casync/manifests}"
REFS_PREFIX="${COMPOSE_REFS_PREFIX:-casync/refs}"
IMAGE_PREFIX="${COMPOSE_IMAGE_PREFIX:-images}"

PUBLIC_BASE_URL="${COMPOSE_PUBLIC_BASE_URL:-https://rokkitpokkit.samcday.com}"
ENABLE_PUBLISH_RAW="${COMPOSE_ENABLE_PUBLISH:-0}"
BUCKET="${COMPOSE_BUCKET:-}"
ENDPOINT_URL="${COMPOSE_ENDPOINT_URL:-${B2_ENDPOINT_URL:-}}"
